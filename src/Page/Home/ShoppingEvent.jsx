        ...
        <div>
            <div className="flex flex-col items-center py-12 bg-gradient-to-r from-orange-100 to-gray-100">
                <div className="flex flex-wrap justify-center items-center gap-10">
                    <div>
                        <img className="deliveryBoy" src="https://i.ibb.co/xm0jrK4/Pngtree-a-young-boy-riding-an-3637498-1.png" alt="" />
                    </div>
                    <div className="text-center md:text-start items-center  mx-3 md:mx-0">
                        <h2 className="comingSoon text-4xl  md:text-6xl font-bold mb-4">Free Home delivery <br /> COMING SOON</h2>
                        <p className="text-lg md:text-2xl mb-6">Right we only don't provide that's service in here but you call for home delivery</p>
                        <div className="flex mb-6 space-x-4">
                            {/* <CountdownTimer targetDate={targetDate} /> */}
                        </div>
                        <button className="bg-orange-500 text-white px-4 py-2 rounded-md mb-6">Sign-up for delivery</button>
                    </div>
                </div>
